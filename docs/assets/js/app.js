...
function fadeInProfile() {
  document.getElementById("username-input").style.transition = "opacity 0.25s ease-in 0.4s";
  document.getElementById("username-input").style.opacity = "100%";
  document.getElementById("bio-input").style.transition = "opacity 0.25s ease-in 0.4s";
  document.getElementById("bio-input").style.opacity = "100%";
  document.getElementById("profile-picture").style.transition = "opacity 0.25s ease-in 0.4s";
  document.getElementById("profile-picture").style.opacity = "100%";
  document.getElementById("save-account").style.transition = "opacity 0.25s ease-in 0.4s";
...
function authopen() {
  ...
  if (temp == "none") {
      ...
      document.getElementById("header-icon2").style.marginTop = "40px"; // IF NOT IN ACCOUNT
